...
using System.Linq;
using Confab.Modules.Agendas.Domain.Consts;
...
namespace Confab.Modules.Agendas.Domain.Submissions.Entities
{
    public sealed class Submission : AggregateRoot
    {
        ...
        public static Submission Create(AggregateId id, ConferenceId conferenceId, string title,
            string descriptionTitle, int level,
            IEnumerable<string> tags, ICollection<Speaker> speakers)
        {
            ...
            submission.ChangeDescription(descriptionTitle);
            submission.ChangeLevel(level);
            submission.Status = SubmissionStatus.Pending;
            submission.Tags = tags;
            submission.ChangSpeakers(speakers);
        ...
        public void ChangSpeakers(IEnumerable<Speaker> speakers)
        {
